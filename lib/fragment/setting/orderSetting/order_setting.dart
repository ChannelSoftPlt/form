...
class _OrderSettingState extends State<OrderSetting> {
  ...
  bool email, selfCollect, deliveryDate, deliveryTime, allowEmailNotification, allowWhatsApp;
            ...
            if (object.hasData) {
              if (object.connectionState == ConnectionState.done) {
                ...
                if (data['status'] == '1') {
                  ...
                  Merchant merchant = responseJson.map((jsonObject) => Merchant.fromJson(jsonObject)).toList()[0];
                  ...
                  allowWhatsApp = merchant.allowWhatsApp != '1';
                  ...
                  workingDays = workingDay != null ? List.from(workingDay) : null;
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: '${AppLocalizations.of(context).translate('optional_fields')}',
                                            style: TextStyle(color: Color.fromRGBO(89, 100, 109, 1), fontWeight: FontWeight.bold)),
                                        TextSpan(text: '\n'),
                                        TextSpan(
                                          text: '${AppLocalizations.of(context).translate('field_will_show_in_emenu')}',
                                  ...
                                  CheckboxListTile(
                                    ...
                                    subtitle: RichText(
                                      text: TextSpan(
                                        ...
                                        children: <TextSpan>[
                                          TextSpan(
                                              text: '${AppLocalizations.of(context).translate('email_notification_hint')}',
                                              style: TextStyle(fontSize: 12, color: Colors.grey)),
                                          TextSpan(text: '\n'),
                                          TextSpan(
                                            text: '${AppLocalizations.of(context).translate('email_notification_hint_2')}',
                            ...
                            CheckboxListTile(
                              title: Text(
                                '${AppLocalizations.of(context).translate('whatsapp_notification')}',
                                style: TextStyle(fontSize: 15),
                              ),
                              subtitle: Text('${AppLocalizations.of(context).translate('whatsapp_notification_hint')}',
                                  style: TextStyle(fontSize: 12, color: Colors.grey)),
                              value: allowWhatsApp,
                              onChanged: (newValue) {
                                SharePreferences().save('allow_send_whatsapp', newValue ? '0' : '1');
                                allowWhatsApp = newValue;
                                refreshController.add('');
                              },
                              controlAffinity: ListTileControlAffinity.trailing, //  <-- leading Checkbox
                            ),
                            ...
                            CheckboxListTile(
                              ...
                              subtitle: RichText(
                                text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    TextSpan(
                                        text: '${AppLocalizations.of(context).translate('self_collect_enable_hint')}',
                                        style: TextStyle(fontSize: 12, color: Colors.grey)),
                                    TextSpan(text: '\n'),
                                    TextSpan(
                                      text: '${AppLocalizations.of(context).translate('self_collect_enable_hint_2')}',
                                      style: TextStyle(color: Colors.red, fontSize: 12),
                                    ),
                                  ],
                                ),
                                ...
                                Padding(
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: '${AppLocalizations.of(context).translate('date_time_setting')}',
                                            style: TextStyle(color: Color.fromRGBO(89, 100, 109, 1), fontWeight: FontWeight.bold)),
                                        TextSpan(text: '\n'),
                                        TextSpan(
                                          text: '${AppLocalizations.of(context).translate('date_time_setting_description')}',
                                          style: TextStyle(color: Colors.grey, fontSize: 12),
                                        ),
                                      ],
                                    ),
                            ...
                            CheckboxListTile(
                              title: Text("${AppLocalizations.of(context).translate('delivery_date')}", style: TextStyle(fontSize: 15)),
                              subtitle: Text(
                            ...
                            ListTile(
                              ...
                              subtitle: RichText(
                                text: TextSpan(
                                  children: <TextSpan>[
                                    TextSpan(
                                      text: '${AppLocalizations.of(context).translate('working_time_description')}',
                                      style: TextStyle(fontSize: 12, color: Colors.grey),
                                    ),
                                    TextSpan(text: '\n'),
                                    TextSpan(
                                      text: '${AppLocalizations.of(context).translate('working_time_description_2')}',
                                      style: TextStyle(color: Colors.red, fontSize: 12),
                                    ),
                                  ],
                                ),
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: TextField(
                                      ...
                                      onTap: () => selectTime(startTime.text, startTime),
                                  ...
                                  Expanded(
                                    ...
                                    child: TextField(
                                      readOnly: true,
                                      controller: endTime,
                                      onTap: () => selectTime(endTime.text, endTime),
                                      style: TextStyle(fontSize: 12, color: Colors.black87),
                                      textAlign: TextAlign.center,
                                      decoration: InputDecoration(
                                ...
                                Padding(
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: '${AppLocalizations.of(context).translate('order_reminder')}',
                                            style: TextStyle(color: Color.fromRGBO(89, 100, 109, 1), fontWeight: FontWeight.bold)),
                                        TextSpan(text: '\n'),
                                        TextSpan(
                                          text: '${AppLocalizations.of(context).translate('order_reminder_hint')}',
                                          style: TextStyle(color: Colors.grey, fontSize: 12),
                                        ),
                                        TextSpan(text: '\n'),
                                        TextSpan(
                                          text: '${AppLocalizations.of(context).translate('order_reminder_hint_2')}',
                                          style: TextStyle(color: Colors.red, fontSize: 12),
                                        ),
                                      ],
                                    ),
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                  hintText: AppLocalizations.of(context).translate('order_reminder_hint_3'), hintStyle: TextStyle(fontSize: 14)),
                            ),
                            SizedBox(
                              height: 40,
                            ),
  ...
  Widget workingDayList() {
    return GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, crossAxisSpacing: 5, mainAxisSpacing: 5, childAspectRatio: 3),
          ...
          return Card(
            ...
            child: ListTile(
              ...
              title: Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(color: workingDays[i] == 0 ? Colors.white : Colors.black54),
              ),
            ),
          );
        });
  ...
  selectTime(time, TextEditingController controller) {
    ...
    DatePicker.showTimePicker(context, showTitleActions: true, showSecondsColumn: false, currentTime: time, onConfirm: (date) async {
  ...
  checkingWorkingTime(context) {
    ...
    CustomSnackBar.show(context, '${AppLocalizations.of(context).translate('invalid_working_time')}');
    return false;
  }

  checkingMinPurchase(context) {
    try {
      var minPurchaseAmount = double.parse(minPurchase.text.isEmpty ? '0' : minPurchase.text);
      minPurchase.text = minPurchaseAmount.toStringAsFixed(2);
      return true;
    } catch ($e) {
      CustomSnackBar.show(context, '${AppLocalizations.of(context).translate('invalid_min_purchase')}');
      return false;
    }
  }
